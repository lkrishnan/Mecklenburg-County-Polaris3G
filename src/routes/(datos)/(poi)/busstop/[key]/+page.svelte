<div class="pt-2 text-sm">
    <Heading title="Point of Interest: Bus Stop" iconname="pushpin" />
...
<script>
    ...
    poi.subscribe( async value => {
        if( Object.keys( value ).length > 0 ){
            ...
            infos = [ 
                { label: "Name", value: value.busstop }, 
                { label: "Routes", value: value.routes }, 
            ...
            btns = [ 
                { label: "CATS Website", icon: "link", link: `https://www.charlottenc.gov/CATS/Bus` },
