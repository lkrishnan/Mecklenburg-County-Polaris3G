    ...
    const handleClick = event => {
        ...
        handleLocChange = poi => {
            ...
            infos = [ 
                ...
                { label: "Address", value: _poi.address  }, 
                { label: "Type", value: _poi.prktype },
                { label: "Status", value: _poi.status },
            ...
            btns = [ 
                ...( _poi.lat && _poi.lng ? [ { label: "Parks Nearby", icon: "park", link: `https://mcmap.org/geoportal/#${_poi.lng},${_poi.lat}/parks` } ]: [ ] ),
