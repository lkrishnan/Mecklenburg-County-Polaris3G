...
icon = ( typ, width=36, height=36 ) => {
    const lookup = {
        ...
        minus: `<svg xmlns="http://www.w3.org/2000/svg" height="${height}" viewBox="0 -960 960 960" width="${width}"><path d="M200-440v-80h560v80H200Z"/></svg>`,
        ...
        plus: `<svg xmlns="http://www.w3.org/2000/svg" height="${height}" viewBox="0 -960 960 960" width="${width}"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>`,
